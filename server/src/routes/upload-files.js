...
const parseDate = (formats: string[]) => (value: string, defaultValue?: any) => {
...
const filterImages = filter(({mimetype}: IUploadFile) => mimetype.substr(0, 6) === 'image/');
...
export async function uploadFiles(uploadFolder: string, dataFolder: string, pFiles: IUploadFile[]) {
